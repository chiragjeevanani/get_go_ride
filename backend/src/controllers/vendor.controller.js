...
export const getVendorById = async (req, res, next) => {
  try {
    ...
    if (!isAdmin) {
      ...
      query = query.select('name profileImage nativeCity vehicleType vehicleImages serviceCategories operatingAreas isVerified rating totalRatings leadsWon reliabilityScore onboardingComplete');
    }
