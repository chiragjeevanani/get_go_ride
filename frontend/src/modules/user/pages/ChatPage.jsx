...
import { 
  ...
  Phone, Mail, User, Truck, Calendar, Clock
} from "lucide-react";
                ...
                {msg.type === "contact" ? (
                  <div className="p-4 space-y-3 min-w-[200px]">
                    <div className="flex items-center gap-3 border-b border-zinc-100 pb-3">
                      ...
                      <div>
                        <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Shared Contact</p>
                        <p className="text-sm font-black text-black leading-none mt-0.5">{msg.metadata?.name || 'My Info'}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 text-[10px] font-bold text-emerald-600 uppercase tracking-tight">
                      <Phone className="w-3 h-3" /> {msg.metadata?.phone}
                    </div>
                    <p className="text-[8px] font-bold text-zinc-400 uppercase">Information shared with driver partner</p>
                  </div>
                ) : msg.type === "card" ? (
                  <div className="p-4 space-y-4 min-w-[220px]">
                    <div className="flex items-center gap-2 border-b border-zinc-100 pb-2">
                      <Truck className="w-4 h-4 text-primary" />
                      <span className="text-[10px] font-black text-black uppercase tracking-widest">Journey Details Shared</span>
                    </div>
